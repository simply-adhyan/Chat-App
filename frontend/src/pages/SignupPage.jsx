...
import { MessageSquare, User, Mail, EyeOff, Eye, Loader2, Key, Lock } from 'lucide-react';
...
const SignupPage = () => {
	...
	// console.log("checking use authstore"+{ signup},{isSigningUp});
	...
	const handleSubmit = (e) => {
		...
		console.log("checking handle submit",success,{formData})
